...
public class Main {
    public static void main(String[] args) {
        Employee employee1 = new Employee("Zehra Çakır", 1000, 39, 2015);
        Employee employee2 = new Employee("Ali Kale", 1000, 40, 2000);
        Employee employee3 = new Employee("Veli Kule", 1000, 45, 2010);
